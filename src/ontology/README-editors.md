These notes are for the EDITORS of pco
...
Make sure you have an ID range in the [idranges file](pco-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [pco-edit.owl](pco-edit.owl)

** DO NOT EDIT pco.obo OR pco.owl in the top level directory **

[../../pco.owl](../../pco.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/PopulationAndCommunityOntology/pco) for details.
 ...
 * [pco-idranges.owl](pco-idranges.owl)
...
This generates derived files such as pco.owl and pco.obo and places
 ...
 * https://github.com/PopulationAndCommunityOntology/pco/releases
 * https://github.com/PopulationAndCommunityOntology/pco/releases/new
...
what is in the `owl:versionIRI` of the derived pco.owl (`data-version` in
pco.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/pco.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/pco/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/PopulationAndCommunityOntology/pco.svg?branch=master)](https://travis-ci.org/PopulationAndCommunityOntology/pco)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/PopulationAndCommunityOntology](https://travis-ci.org/profile/PopulationAndCommunityOntology)
 2. click the "Sync account" button
 3. Click the tick symbol next to pco
